                ...
                <div class="row g-4 settings-section">
	                <div class="col-12 col-md-4">
		                ...
		                <div class="section-intro">
							Admintraffic dapat melakukan edit data yang tersedia tetapi tidak dapat menghapus data yang sudah tersedia
                        </div>&nbsp;
	                </div>
	                <div class="col-12 col-md-8">
		                <div class="app-card app-card-settings p-4">
						    ...
						    <div class="app-card-body">
							    <form class="settings-form" action="{{ route('admintraffic.update', $order->id) }}" method="POST" enctype="multipart/form-data">
								@method('PUT')
    							@csrf
									<div class="mb-3">
