	                ...
	                <div class="col-12 col-md-8">
		                <div class="app-card app-card-settings p-4">
						    ...
						    <div class="app-card-body">
							    <form class="settings-form" action="{{ route('order.storeImageAdmintraffic') }}" method="POST" enctype="multipart/form-data">
    							@csrf
                                    <div class="mb-3">
                                    ...
                                    <a href="{{ route('admintraffic.order') }}" class="btn btn-light m-0">Cancel</a> &nbsp;
